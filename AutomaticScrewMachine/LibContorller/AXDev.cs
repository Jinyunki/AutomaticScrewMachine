...
//======== PCI-R1604-MLII 전용 함수=========================================================================== 
    ...
    */
    ...
    [DllImport("AXL.dll")] public static extern uint AxlECatWriteSdoFromAxisDouble(int lAxisNo, uint wObjectIndex, byte byObjectSubIndex, double dData);
    ...
    [DllImport("AXL.dll")] public static extern uint AxlECatWriteSdoFromAxisDword(int lAxisNo, ushort wObjectIndex, byte byObjectSubIndex, uint dwData);
    ...
    [DllImport("AXL.dll")] public static extern uint AxlECatWriteSdoFromAxisWord(int lAxisNo, ushort wObjectIndex, byte byObjectSubIndex, ushort wData);
    ...
    [DllImport("AXL.dll")] public static extern uint AxlECatWriteSdoFromAxisByte(int lAxisNo, ushort wObjectIndex, byte byObjectSubIndex, byte byData);
