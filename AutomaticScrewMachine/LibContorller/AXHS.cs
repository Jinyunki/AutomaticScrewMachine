...
public enum AXT_MOTION_HOME_INTERLOCK_DEF:uint
{
...
public enum AXT_MOTION_COMPENSATION_USE_REVERSE : uint
{
    COMPENSATION_REVERSE_UNUSE = 0x0,
    COMPENSATION_REVERSE_USE   = 0x1,
}

public enum AXT_MOTION_COMPENSATION_INTERPOLATION_METHOD : uint
{
    INTERPOLATION_LINEAR       = 0x0,
    INTERPOLATION_CUBIC_SPLINE = 0x1,
}
